...
set CLASSPATH=%APP_HOME%\lib\gradle-travis-sample-1.0-SNAPSHOT.jar;%APP_HOME%\lib\postgresql-42.2.8.jar;%APP_HOME%\lib\spring-context-5.2.1.RELEASE.jar;%APP_HOME%\lib\spring-aop-5.2.1.RELEASE.jar;%APP_HOME%\lib\spring-beans-5.2.1.RELEASE.jar;%APP_HOME%\lib\spring-expression-5.2.1.RELEASE.jar;%APP_HOME%\lib\spring-core-5.2.1.RELEASE.jar;%APP_HOME%\lib\spring-jcl-5.2.1.RELEASE.jar
